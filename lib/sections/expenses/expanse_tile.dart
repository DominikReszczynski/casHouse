          ...
          InkWell(
            ...
            child: Row(
              ...
              children: [
                ...
                Row(
                  children: [
                    Text("${widget.expanse.amount} ${widget.expanse.currency}"),
              ...
              ? Column(
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Text(getCategoryName(ExpenseCategory.values.firstWhere(
                            (e) => e.toString() == widget.expanse.category))),
                      ],
                    ),
                    Row(
                    ...
                    Row(
                      ...
                      children: [
                        IconButton(
                            onPressed: () {
                              widget.provider.removeExpense(widget.expanse.id!);
                            },
                            icon: Icon(
                              MdiIcons.delete,
